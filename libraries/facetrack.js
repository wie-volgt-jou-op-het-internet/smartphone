function initFacetracking(callback) {
    if (!callback) {
    ...
    */
    ...
    var cascadeurl = './libraries/facefinder';
    ...
    */
    ...
    var puplocurl = './libraries/puploc.bin'
    ...
    var processfn = function (video, dt) {
        ...
        for (i = 0; i < dets.length; ++i)
            ...
            if (dets[i][3] > 50.0) {
                ...
                //////////////////////////////////////////////////////////////
                // Execute callback with the position of the detected face. //
                //////////////////////////////////////////////////////////////
                callback((640 - dets[i][1]) / 640, dets[i][0] / 480);
